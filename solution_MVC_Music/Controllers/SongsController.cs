...
namespace solution_MVC_Music.Controllers
{
    public class SongsController : Controller
    {
        ...
        {
            ViewData["AlbumID"] = new SelectList(_context.Albums.OrderBy(x => x.Name), "ID", "Name");
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,AlbumID,GenreID")] Song song)
        {
            try {
                ...
                ViewData["AlbumID"] = new SelectList(_context.Albums.OrderBy(x => x.Name), "ID", "Name", song.AlbumID);
                ViewData["GenreID"] = new SelectList(_context.Genres.OrderBy(x => x.Name), "ID", "Name", song.GenreID);
